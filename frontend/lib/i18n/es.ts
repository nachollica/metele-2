...
export const es = {
  ...
  connections: {
    title: "Conexiones",
    description:
      "Genera un enlace para conectar con otros jugadores. Cualquiera que lo abra podrá conectar contigo, así que compártelo solo con personas de confianza.",
    inviteLabel: "Tu enlace de invitación",
    createInvite: "Crear enlace de invitación",
    creatingInvite: "Creando…",
    regenerateInvite: "Regenerar",
    regeneratingInvite: "Regenerando…",
    createFailed: "No se pudo crear el enlace de invitación.",
    regenerateFailed: "No se pudo regenerar el enlace de invitación.",
    copyLink: "Copiar enlace",
    linkCopied: "Copiado.",
    copyFailed: "No se pudo copiar el enlace.",
    disableInvite: "Deshabilitar",
    disableConfirmTitle: "¿Deshabilitar tu enlace de invitación?",
    disableConfirmDescription:
      "Quien tenga el enlace actual ya no podrá conectar contigo a través de él. Puedes crear uno nuevo cuando quieras.",
    disableConfirm: "Deshabilitar",
    disableCancel: "Cancelar",
    disableFailed: "No se pudo deshabilitar el enlace de invitación.",
    connectionsTitle: "Tus conexiones",
    connectionsCount: "{count} conexiones",
    emptyConnections: "Todavía no tienes conexiones. Comparte tu enlace de invitación para conectar con otros.",
    loadFailed: "No se pudieron cargar tus conexiones.",
    removeConnection: "Quitar",
    removeConnectionConfirmTitle: "¿Quitar esta conexión?",
    removeConnectionConfirmDescription:
      "Ya no estarán conectados entre sí. Esto no le notifica a la otra persona.",
    removeConnectionConfirm: "Quitar",
    removeConnectionCancel: "Cancelar",
    removeConnectionFailed: "No se pudo quitar esa conexión.",
  },

  connect: {
    title: "Conectar",
    invitedBy: "{name} te invitó a conectar en Flowfic.",
    signInTitle: "Conecta en Flowfic",
    signInDescription: "Inicia sesión o crea una cuenta para conectar con {name}.",
    signInToConnect: "Iniciar sesión para conectar",
    connectWith: "Conectar con {name}",
    connecting: "Conectando…",
    connectFailed: "No se pudo conectar. Intenta de nuevo.",
    retry: "Intentar de nuevo",
    connectedWith: "Ahora estás conectado con {name}.",
    goToConnections: "Ir a tus conexiones",
    backHome: "Volver al inicio",
    invalidTitle: "Este enlace de invitación no es válido",
    invalidBody: "Puede haber expirado o haber sido deshabilitado. Pide uno nuevo a quien te lo compartió.",
    ownLinkTitle: "Este es tu propio enlace de invitación",
    ownLinkBody: "Compártelo con otra persona para conectar con ella.",
  },
  ...
  sidebar: {
    ...
    privacyButtonLabel: "Visibilidad: {level}",
    privacyMenuLabel: "Cambiar visibilidad",
    privacyPrivate: "Privada",
    privacyPrivateDescription: "Solo tú puedes ver esta historia.",
    privacyConnections: "Conexiones",
    privacyConnectionsDescription: "Visible para tus conexiones.",
    privacyPublic: "Pública",
    privacyPublicDescription: "Visible para cualquier jugador con sesión iniciada.",
    privacyUpdateFailed: "No se pudo actualizar la visibilidad de la historia.",
  },
