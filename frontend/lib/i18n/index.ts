...
export { DEFAULT_LOCALE, SUPPORTED_LOCALES, getTranslations } from "./config"
...
/**
 * Read the current locale from context, provided by the `LocaleProvider`
 * mounted in the root layout (see `lib/i18n/locale-provider.tsx`).
 */
