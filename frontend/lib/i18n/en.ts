...
export const en = {
  ...
  dashboard: {
    ...
    newStory: "New story",
    writingTitle: "In the flow",
    writingSubtitle: "Keep your hands moving.",
    quickStartTitle: "Write non-stop",
    quickStartBadge: "Let's write!",
    quickStartHint: "No distractions. Just you and your story.",
    ...
    challengesForYou: "Challenges for you",
    promptOfDay: "Prompt of the day",
    writeNow: "Write now",
    ctaTitle: "Enter the flow. Tell your story.",
    ctaButton: "Start now",
    quote: "Don't wait for inspiration. Flow is built by writing.",
  },

  // Subtitles for the non-home sections (shown under the section title).
  sections: {
    stories: "Your latest writing sprints.",
    challenges: "Daily prompt and goals to push you.",
    stats: "Your writing, by the numbers.",
    achievements: "Milestones you've unlocked.",
    settings: "Configure your next sprint.",
  },
