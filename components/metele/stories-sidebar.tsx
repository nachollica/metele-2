...
import { deleteStory, fetchStories, type Story } from "@/lib/metele/stories-api"
...
function StoryRow({ story, onSelect, onDelete }: RowProps) {
  ...
  return (
    <li>
      <div className="group hover:bg-accent/25 focus-within:bg-accent/25 relative flex items-start rounded-md transition-colors">
        <Tag
